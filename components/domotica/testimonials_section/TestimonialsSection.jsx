...
const temp = [
    ...
    },
    {
        ...
        name: "Sundar Pichai",
        prof: "CEO de Google",
        text: "La domótica ofrece un gran potencial para transformar nuestros hogares en espacios más eficientes y personalizados. Al invertir en domótica, estamos apostando por un estilo de vida más conveniente y adaptable a nuestras necesidades",
...
const TestimonialsSection = () => {
    return (
        <>
            <SectionTitle>Palabra de expertos</SectionTitle>
